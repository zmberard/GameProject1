...
{
    public class SecondSplashScreen : GameScreen
    {
        ...
        public SecondSplashScreen(int Damage)
        {
            damage = Damage;
        }
        ...
        public override void HandleInput(GameTime gameTime, InputState input)
        {
            ...
            {
                ExitScreen();
                LoadingScreen.Load(ScreenManager, true, PlayerIndex.One, new BoatGameLevel3(damage));
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                //ScreenManager.GraphicsDevice.Clear(Color.Black);
                _spriteBatch.DrawString(_gameFont1, "Theres no way to kill it...", new Vector2(300, 15), Color.WhiteSmoke);
                _spriteBatch.DrawString(_gameFont1, "Too big... the tentacles...", new Vector2(300, 45), Color.WhiteSmoke);
            ...
            {
                // Draw the white text
                _spriteBatch.DrawString(_gameFont1, "You have to listen to me", new Vector2(220, 15), Color.White);
                _spriteBatch.DrawString(_gameFont1, "LOOK OUT!", new Vector2(220, 45), Color.White);
                ...
                if (_whiteTextDisplayTime <= TimeSpan.Zero)
                {
                    ...
                    _spriteBatch.DrawString(_gameFont1, "You have to listen to me", new Vector2(220, 15), Color.Transparent);
                    _spriteBatch.DrawString(_gameFont1, "LOOK OUT!", new Vector2(220, 45), Color.Transparent);
                }
            }
